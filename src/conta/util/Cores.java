...
public class Cores {
	...
	public static final String TEXT_BACKGROUND_BLACK = "\033[40m";
	public static final String TEXT_BACKGROUND_RED = "\033[41m";
	public static final String TEXT_BACKGROUND_GREEN = "\033[42m";
	public static final String TEXT_BACKGROUND_YELLOW = "\033[43m";
	public static final String TEXT_BACKGROUND_BLUE = "\033[44m";
	public static final String TEXT_BACKGROUND_PURPLE = "\033[45m";
	public static final String TEXT_BACKGROUND_CYAN = "\033[46m";
	public static final String TEXT_BACKGROUND_WHITE = "\033[47m";
}
